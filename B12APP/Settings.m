...
-(id)initWithCoder:(NSCoder*)coder
{
    ...
    NSLog(@"the coderin initWithCoder value is :%@",coder);
  ...
  dayMask = [coder decodeIntForKey:@"dayMask"];
    NSLog(@"the daymask in initWithCoder value is :%d",dayMask);
...
{  
  ...
  [coder encodeInt:dayMask forKey:@"dayMask"];
    //NSLog(@"the coderin encodeWithCoder value is :%@",[coder encodeInt:dayMask forKey:@"dayMask"]);
